...
namespace webAPI.Migrations
{
    ...
    [Migration("20240102224355_modyfikacjaUbezpieczenia")]
    partial class modyfikacjaUbezpieczenia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webAPI.Models.Oczekujace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webAPI.Models.Wypozyczenie", b =>
                {
                    ...
                    b.Property<int?>("UbezpieczenieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webAPI.Models.Klient", b =>
                {
                    ...
                    b.Property<string>("KodWeryfikacyjny")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("webAPI.Models.Oczekujace", b =>
                {
                    b.HasOne("webAPI.Models.Wypozyczenie", "Wypozyczenie")
                        .WithMany()
            ...
            modelBuilder.Entity("webAPI.Models.Wypozyczenie", b =>
                {
                    ...
                    b.HasOne("webAPI.Models.Ubezpieczenie", "Ubezpieczenie")
                        .WithMany()
                        .HasForeignKey("UbezpieczenieId");
